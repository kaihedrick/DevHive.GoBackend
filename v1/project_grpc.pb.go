...
const (
	ProjectService_GetProject_FullMethodName    = "/devhive.v1.ProjectService/GetProject"
	ProjectService_CreateProject_FullMethodName = "/devhive.v1.ProjectService/CreateProject"
	ProjectService_UpdateProject_FullMethodName = "/devhive.v1.ProjectService/UpdateProject"
	ProjectService_DeleteProject_FullMethodName = "/devhive.v1.ProjectService/DeleteProject"
	ProjectService_ListProjects_FullMethodName  = "/devhive.v1.ProjectService/ListProjects"
	ProjectService_AddMember_FullMethodName     = "/devhive.v1.ProjectService/AddMember"
	ProjectService_RemoveMember_FullMethodName  = "/devhive.v1.ProjectService/RemoveMember"
	ProjectService_ListMembers_FullMethodName   = "/devhive.v1.ProjectService/ListMembers"
)
...
func (c *projectServiceClient) AddMember(ctx context.Context, in *AddMemberRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
func (UnimplementedProjectServiceServer) AddMember(context.Context, *AddMemberRequest) (*emptypb.Empty, error) {
