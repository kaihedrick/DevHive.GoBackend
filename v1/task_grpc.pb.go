...
const (
	TaskService_GetTask_FullMethodName          = "/devhive.v1.TaskService/GetTask"
	TaskService_CreateTask_FullMethodName       = "/devhive.v1.TaskService/CreateTask"
	TaskService_UpdateTask_FullMethodName       = "/devhive.v1.TaskService/UpdateTask"
	TaskService_DeleteTask_FullMethodName       = "/devhive.v1.TaskService/DeleteTask"
	TaskService_ListTasks_FullMethodName        = "/devhive.v1.TaskService/ListTasks"
	TaskService_AssignTask_FullMethodName       = "/devhive.v1.TaskService/AssignTask"
	TaskService_UpdateTaskStatus_FullMethodName = "/devhive.v1.TaskService/UpdateTaskStatus"
)
...
func (c *taskServiceClient) UpdateTaskStatus(ctx context.Context, in *UpdateTaskStatusRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
func (UnimplementedTaskServiceServer) UpdateTaskStatus(context.Context, *UpdateTaskStatusRequest) (*emptypb.Empty, error) {
